...
locals {
  alb = {
    container_name   = module.this.id == "" ? module.this.id : coalesce(var.alb_container_name, module.this.id)
    container_port   = var.container_port
    elb_name         = null
    target_group_arn = module.alb_ingress.target_group_arn
  }
  nlb = {
    container_name   = module.this.id == "" ? module.this.id : coalesce(var.nlb_container_name, module.this.id)
...
module "alb_target_group_cloudwatch_sns_alarms" {
  source  = "../aws-alb-target-group-cloudwatch-sns-alarms"
